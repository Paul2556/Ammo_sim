...
heat_visibility_multiplier = 2.25 #default 2.55, higher values make heat more visible but also make it more opaque, lower values make it less visible but also more transparent
